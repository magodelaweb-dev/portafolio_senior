...
case_studies = [
  {
    ...
    subtitle: "Buk, 2025 — De un componente transversal acoplado a supuestos implícitos a soporte nativo de ex-colaboradores, con cero regresiones en módulos críticos",
    context: <<~MD,
      ...
      **Compromisos de ingeniería (trade-offs)**
      ...
      - *QA exhaustivo vs. velocidad de despliegue*: invertir en revisión atómica de
        *pull requests* con el equipo de Plataforma y en pruebas de regresión cruzadas
        extendió el *time-to-market* de la funcionalidad, a cambio de eliminar el riesgo
    ...
    outcome: <<~MD
      ...
      | Incidencias en producción    | Riesgo alto por impacto transversal        | 0 regresiones en módulos críticos (nómina y asistencia)        |
      | Gobernanza técnica           | Código acoplado a supuestos implícitos     | Cambios aprobados por el equipo de Plataforma en su totalidad  |
